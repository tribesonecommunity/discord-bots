...
total_games = 0
print(
    "id,name,wins,losses,ties,rated_ts_mu,rated_ts_sigma,unrated_ts_mu,unrated_ts_sigma,diff"
)
...
for i, player in enumerate(players):
    ...
    for finished_game in finished_games:
        ...
        if finished_game.winning_team == team:
            ...
            losses += 1
    print(
        f"{player.id},{player.name},{wins},{losses},{ties},{player.rated_trueskill_mu},{player.rated_trueskill_sigma},{player.unrated_trueskill_mu},{player.rated_trueskill_sigma},{player.rated_trueskill_mu - player.unrated_trueskill_mu}"
    )
