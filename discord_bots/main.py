...
from discord_bots.config import LEADERBOARD_CHANNEL, SHOW_CHANNEL_ID
...
async def on_message(message: Message):
    ...
    if SHOW_CHANNEL_ID:
        if (message.content.startswith(COMMAND_PREFIX) and 'showchannelid' in message.content):
            await message.channel.send(content=message.channel.id)
